	...
	<div class="container-fluid PE">
		...
		<div class="row head_nav">
			...
			<div class="form-horizontal col-md-6 col-xs-12">
				...
				<div class="col-md-3">
					<button type="button" class="btn btn-default bg_dblue btn-add" data-target="#addsupplier" data-toggle="modal"> Add Supplier </button>
				</div> 
			  ...
			  <div class="form-group">
			    <label class="control-label col-md-2" for="date">Date</label>
			  	...
			  	<div class="form-group txtbox">
				    <label class="control-label col-md-4" for="PEterms">Terms</label>
				    <div class="col-md-5">
				      <input type="text" class="form-control" id="PEterms">
				    </div>
				 </div>
			  	
			  	<div class="form-group txtbox">
				    <label class="control-label col-md-4" for="PEcurr">Currency Rate</label>
				    <div class="col-md-5">
		...
		<!-- ============== TABLE =============== -->
		 ...
		 <div class="row">
		 	...
		 	<div class="tbl_wrap">
				<table class="table table-hover">
		          ...
		          <tbody>
		           ...
		           <tr  data-toggle="modal" data-target="#PEModal">
		           		<td class="">1</td>
						<td class="">0509</td>
						<td class="">1</td>
						<td class="">12</td>
	        ...
	        <!-- ============= MODAL =============== -->
	        <div class="modal fade" id="PEModal" tabindex="-1" role="dialog" >
		...
		<div class="row form-inline TotalAmt">
				<label for="PEtotalAmt" class="col-md-offset-2 col-md-2 col-xs-6 text-right">Total Amount</label>
				<input type="text" class="form-control col-md-2 col-xs-6" id="PEtotalAmt" disabled placeholder="Php. 0.00">
				<input type="text" class="form-control col-md-offset-1 col-md-2 col-xs-6" id="PEtotalAmt" disabled placeholder="Yuan 0.00">
		</div>
