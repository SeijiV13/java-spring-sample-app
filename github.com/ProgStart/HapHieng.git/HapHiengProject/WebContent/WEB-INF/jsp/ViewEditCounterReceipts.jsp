...
<div id="page-content-wrapper">
	...
	<div class="container-fluid">
		<!-- TITLE OF PAGE -->
		<h3>View/Edit Counter Receipts</h3>
		<br>
		<div class="row">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<label for="supplierfilter">Customer Filter</label> <select
				...
				<div class="tbl_wrap">
					<div class="table-responsive">
						<table class="table table-block">
							<thead>
								<tr>
									<th class="bg_dblue text-nowrap">Ctr Ref.</th>
									<th class="bg_dblue text-nowrap">Date</th>
									<th class="bg_dblue text-nowrap">DateRef</th>
				...
				<div class="tbl_wrap">
					<div class="table-responsive">
						<table class="table table-block">
							<thead>
								<tr>
									<th class="bg_dblue text-nowrap">Ref</th>
									<th class="bg_dblue text-nowrap">Date</th>
									<th class="bg_dblue text-nowrap">Agent</th>
									<th class="bg_dblue text-nowrap">Discount</th>
									<th class="bg_dblue text-nowrap">Amount</th>
									<th class="bg_dblue text-nowrap">Counter Amount</th>
