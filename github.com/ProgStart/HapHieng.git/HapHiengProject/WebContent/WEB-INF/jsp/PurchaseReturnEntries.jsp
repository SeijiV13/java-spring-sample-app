		...
		<div class="container-fluid PRE">
			...
			<div class="row head_nav">
				<div class="form-horizontal col-md-6 col-xs-12">
					<div class="col-md-3">
					<button type="button" class="btn btn-default bg_dblue btn-add" data-target="#PREAddSupp" data-toggle="modal"> Add Supplier </button>
				</div> 
			...
			<!-- MODAL FOR ADD SUPPLIER -->
				<div class="modal fade" id="PREAddSupp" role="dialog">
			...
			<div class="row">
				...
				<div class="btn-group btn-group-justified" role="group">
					...
					<div class="btn-group" role="group">
						<button type="button" class="btn btn-default" data-target="#PREresume" data-toggle="modal">
			...
			<!-- MODAL FOR RESUME BUTTON -->			
				<div class="modal fade" id="PREresume" tabindex="-3" role="dialog">
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      <div class="modal-header">
				        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
