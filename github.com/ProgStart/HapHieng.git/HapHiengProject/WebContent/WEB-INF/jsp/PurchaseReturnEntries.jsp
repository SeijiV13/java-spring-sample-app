...
<div id="page-content-wrapper">
	...
	<div class="container-fluid PRE">
			...
			<div class="form-horizontal col-md-6 col-xs-12">
			  ...
			  <div class="form-group">
			    <label class="control-label col-md-2" for="date">Date</label>
			  	...
			  	<div class="form-group txtbox">
				    <label class="control-label col-md-3" for="PREcurr">Currency Rate</label>
				    <div class="col-md-5">
		...
		<div class="row form-inline TotalAmt">
				<label for="PREtotalAmt" class="col-md-offset-2 col-md-2 col-xs-6 text-right">Total Amount</label>
				<input type="text" class="form-control col-md-2 col-xs-6" id="PREtotalAmt" disabled placeholder="Php. 0.00">
				<input type="text" class="form-control col-md-offset-1 col-md-2 col-xs-6" id="PREtotalAmt" disabled placeholder="Yuan 0.00">
		</div>
