					...
					<div class="form-container">
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<label for="agent">Agent</label> <select name="agent" class="form-control">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<label for="address2">Address 2</label> <input
										name="address2" placeholder="Address 2" type="text" class="form-control"
										>
								</div>

								<div class="form-group">
									<label for="telephone">Telephone</label> <input
										name="telephone" placeholder="Telephone" type="text" class="form-control"
									     >
								</div>
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<label for="residentphone">Resident Phone</label> <input
										name="residentphone" placeholder="Resident Phone" type="text" class="form-control"
										>
								</div>
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<label for="cellphone">Cellphone</label> <input
										name="cellphone" placeholder="Cellphone" type="text" class="form-control"
										>
								</div>
