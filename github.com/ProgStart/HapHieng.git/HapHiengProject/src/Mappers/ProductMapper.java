...
public interface ProductMapper {
	...
	public void addNewSale(String refNo, String date, String customerCode, String terms, String po, String amount,
			String balance, String ctr_ref);
	public void addNewInOut_sale(String item_code, String date, String refNo, String client, String price,
			String currency, String quantity_in, String quantity_out, String quantity_adjustment, String balance,
			String agent);
}
